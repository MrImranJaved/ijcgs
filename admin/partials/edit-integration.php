<div class="wrap">
    <h1>
        ...
        <?php esc_attr_e( 'Edit Integration.', 'ijcgs' ); ?>
    </h1>
        ...
        <div id="post-body" class="metabox-holder ">
            <div id="vuejs-app-div" >
                ...
                <form action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post" >
                    <input type="hidden" name="action" value="ijcgs_Integration">
                    <input type="hidden" name="status" value="edit_Integration" >
                    <input type="hidden" name="ID" value= "<?php echo esc_attr( $_GET["id"] ); ?>" >

                    <div id='FirstPart'>
                        <!-- <h2><?php esc_attr_e( 'Select Event & Spreadsheet :', 'ijcgs' ); ?></h2> -->
                        <table class="widefat">
                            <tbody>
                                <tr class="alternate">
                                    <td class="row-title">  <label for="tablecell"> <?php esc_attr_e( 'Integration Title', 'ijcgs' ); ?> </label>  </td>
                                    <td> <input type="text" class="regular-text"  name="IntegrationTitle" v-model="IntegrationTitle" placeholder="<?php _e( 'Enter title here', 'ijcgs'); ?>" required="required">  </td>
                                    <td> </td>
                                </tr>
                                <tr>
                                    <td class="row-title"> <label for="tablecell"> <?php esc_attr_e( 'Data Source ', 'ijcgs' ); ?>  </label> </td>
                                    <td>
                                        <select name="DataSourceID" id="DataSourceID" v-model="DataSourceID" @change="DataSourceFunc($event)" class="regular-text"  >
                                            <option value=""  > <?php _e( 'select ...', 'ijcgs' ); ?> </option>
                                ...
                                <tr class="alternate" >
                                    <td class="row-title">  <label for="tablecell">  <?php esc_attr_e( 'Spreadsheet & Worksheet ', 'ijcgs' ); ?> </label>  </td>
                                    <td id="gData">
                    ...
                    <p v-if="ok">
                        <input class="button-primary" type="submit" name="saveRelation" value="<?php esc_attr_e( 'Save Relation', 'ijcgs' ); ?>" />
                        <a class="button-secondary" style="color: red" href="<?php echo admin_url('admin.php?page=ijcgs')?>" class="button-secondary"> <?php esc_attr_e( 'Cancel', 'ijcgs' ); ?></a>
                    </p>
