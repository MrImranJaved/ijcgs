 ...
 * @since      3.6.0
 * @package    IJcgs
 * @subpackage IJcgs/admin/partials
 */
?>
...
<div class='wrap'>
	...
	<h1> <?php esc_attr_e( "Step-by-Step instructions for WordPress and WooCommerce update from Google sheet.", "ijcgs" ); ?> </h1>
    ...
    <div id="service_account_help">
        ...
        <div id='step_1'>
            ...
            <p>
                ...
                <!-- Loading Ends -->
                <br><br>
                <b>4.</b> Now please<i><b style="text-decoration: underline; cursor: copy;" title="Click here to copy the code." id='copyCodeI'  onclick="copyCodeFunc()"> copy the below code </b></i>. Don't make any change to the code.  
                <br><br>
<pre id='codePre'>   
<code id='appScriptCode'>
    ...
    function menuCallBackFunc(){
        ...
        // URL
        var acceptUrl = "<?php echo get_site_url() . '/wp-json/ijcgs/accept'?>";
        // initiate request 
        ...
        if(acceptResponseJSON['code'] && acceptResponseJSON['code'] == 200){
            ...
            for(var i = 1; i < 10; i++){
                var updateResponse      = UrlFetchApp.fetch("<?php echo get_site_url() . '/wp-json/ijcgs/update'?>");
