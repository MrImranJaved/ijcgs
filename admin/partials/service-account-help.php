...
<div class='wrap'>
	...
	<h1> <?php esc_attr_e( "Step-by-Step instructions to create service account : HMM", "ijcgs" ); ?> </h1>
    ...
    <div id="service_account_help">
        ...
        <div id='step_10'>
            ...
            <!-- youtube ends -->
           <br>
           <b> Note : If you fail then Try again. Please don't skip any step. try from PC. if you fail again  <a  href=" <?php echo admin_url( 'admin.php?page=ijcgs-contact' ); ?> "> Create a Support ticket </a> from the Plugin Contact Us menu.  - Best Regards </b>
        </div>
    </div>
