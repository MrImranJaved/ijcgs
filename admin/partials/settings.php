<div class="wrap">
	...
	<h1> <?php 
esc_attr_e( "Google service account Settings ", "ijcgs" );
?> </h1>

    <div id="ijcgs_google"> <br>
...
echo  wp_create_nonce( 'ijcgs-google-nonce' ) ;
?>" /> 
...
if ( isset( $credential['client_email'] ) ) {
    ...
    ?>
                ...
                <?php 
    echo  "<a href=" . admin_url( 'admin-post.php?action=google_settings&deleteCredential=1&nonce=' ) . wp_create_nonce( 'ijcgs-google-nonce-delete' ) . " class='button-secondary'  style=' text-decoration: none; color: #7f7f7f; ' >  Remove Credential  </a> " ;
    $ret = $this->googleSheet->ijcgs_token_validation_checker( $token );
...
echo  admin_url( 'admin.php?page=ijcgs-settings&action=log' ) ;
...
echo  admin_url( 'admin.php?page=ijcgs-settings&action=service-account-help' ) ;
...
if ( ijcgs_fs()->is_trial() || ijcgs_fs()->is_not_paying() ) {
    ?>
                    If possible Please purchase the <?php 
    echo  '<a style="text-decoration: none;" href="' . ijcgs_fs()->get_upgrade_url() . '">' . __( ' Professional copy', 'my-text-domain' ) . '</a>' ;
    ?>, 
                    if not please leave a <a style='text-decoration: none;' href='https://wordpress.org/support/plugin/ijcgs/reviews/?filter=5'> 5-star review </a>, It will inspire me to add more awesome feature .    
                    <br><br> 
                    thank you & best regards.
                    <br><br>
                    <b> P.S :</b> <a style="text-decoration: none;" href="<?php 
    echo  admin_url( 'admin.php?page=ijcgs-contact' ) ;
